module "vpc" {
  ...
  cidr = var.cicd.vpc["cidr"]

  azs             = var.cicd.vpc["azs"]
  private_subnets = var.cicd.vpc["private_subnets"]
  public_subnets  = var.cicd.vpc["public_subnets"]

  enable_nat_gateway     = var.cicd.vpc["enable_nat_gateway"]
  single_nat_gateway     = var.cicd.vpc["single_nat_gateway"]
  one_nat_gateway_per_az = var.cicd.vpc["one_nat_gateway_per_az"]

  enable_vpn_gateway = var.cicd.vpc["enable_vpn_gateway"]
